...
class Ui_Form_1(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(22, 109, 356, 30))
        ...
        self.widget1.setGeometry(QtCore.QRect(30, 150, 315, 20))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "大小缩放"))
        self.label.setText(_translate("Form", "输入改变的大小比例："))
        self.pushButton.setText(_translate("Form", "确认"))
        self.label_2.setText(_translate("Form", "缩小输入小于1的数"))
        self.label_3.setText(_translate("Form", "放大输入大于1的数"))
